...
struct HomeTabVew: View {
    ...
    @State var imageTab : String = "book"
    @State var titleTab : String =  "goal"
                ...
                ToolbarItem(placement: .title){
                    Button{
                        ...
                        HStack{
                            ...
                            .foregroundColor(showMenu ? .clear : .black)
                    }
                }
    ...
    func setData() {
        imageTab = UserDefaults.standard.string(forKey: "icon") ?? "book"
        titleTab = UserDefaults.standard.string(forKey: "goal") ?? "Goal"
    }
}
